...
public class Css_ex {
    public static void main(String[] args) {
        ...
        String s2= driver.findElement(By.linkText("Amazon Fire Tablets for the Whole Family")).getCssValue("color");
        String s3= driver.findElement(By.linkText("Amazon Fire Tablets for the Whole Family")).getCssValue("font-size");
        String s4= driver.findElement(By.linkText("Amazon Fire Tablets for the Whole Family")).getCssValue("line-height");
        String s5= driver.findElement(By.linkText("Amazon Fire Tablets for the Whole Family")).getCssValue("font-family");
